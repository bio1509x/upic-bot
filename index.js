...
/////////////////
const BotName = '*upic*'; 
const instagram = 'https://instagram.com/taufik1509_'; 
const whatsapp = 'wa.me/6285609849370'; 
const kapanbotaktif = '----'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@taufik1509_')
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, 'Sedang di proses, silahkan tunggu sebentar!', MessageType.text)
...
axios.get(`https://alfians-api.herokuapp.com/api/yta?url=${teks}`).then((res) => {
	conn.sendMessage(id, 'Sedang di proses, silahkan tunggu sebentar!', MessageType.text)
    let hasil = `Lagu Berhasil Di Download, silahkan lihat hasilnya\nKlik link dibawah\n\nJudul: ${res.data.title}\n\nUkuran audio: ${res.data.filesize}\n\nLink: ${res.data.result}`;
...
if (text.includes("!igstalk")){
  ...
  conn.sendMessage(id, 'harap menunggu...', MessageType.text)
...
axios.get(`https://alfians-api.herokuapp.com/api/ytv?url=${teks}`).then((res) => {
	conn.sendMessage(id, 'Sedang di proses, silahkan tunggu sebentar!', MessageType.text)
    let hasil = `video Berhasil Di Download, silahkan lihat hasilnya\nKlik link dibawah\n\nJudul: ${res.data.title}\n\nUkuran video: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
	conn.sendMessage(id, 'Sedang di proses, silahkan tunggu sebentar!', MessageType.text)
    let hasil = `Berhasil Di Download, silahkan lihat hasilnya\nKlik link dibawah\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://st4rz.herokuapp.com/api/tiktok?url=${tictoc}`).then((res) => {
	 conn.sendMessage(id, 'Sedang di proses, silahkan tunggu sebentar!', MessageType.text)
     let titoe = `Lagu Berhasil Di Download, silahkan lihat hasilnya\nKlik link dibawah\n\nJudul: ${res.data.deskripsi} \n\nDurasi: ${res.data.durasi}\n\nNama: ${res.data.nama}\n\nUrl: ${res.data.urlvideo}`;
